    ...
    return (
      <span
        className={[
          ...
          light
            ? "border-[color-mix(in_srgb,var(--theme-text)_16%,transparent)] bg-[color-mix(in_srgb,var(--theme-text)_5%,transparent)] text-theme-muted"
  ...
  return (
    <span
      className={[
        ...
        light
          ? status === "available"
            ? "border-[#7a9a7e]/45 bg-[color-mix(in_srgb,#7a9a7e_14%,#faf7f0)] text-theme"
            : "border-[color-mix(in_srgb,#5a6a82_35%,transparent)] bg-[color-mix(in_srgb,#5a6a82_10%,#faf7f0)] text-theme"
          : status === "available"
