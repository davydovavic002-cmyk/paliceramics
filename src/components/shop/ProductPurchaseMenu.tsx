...
export function ProductPurchaseMenu({
  ...
  return (
    <div ref={rootRef} className="shop-product-buy relative z-30 w-full min-w-0">
      <button
        type="button"
      ...
      <AnimatePresence>
        {open ? (
          <motion.div
            role="menu"
            className="shop-action-dropdown-panel shop-action-dropdown-panel-up shop-buy-menu-panel delivery-faq-panel absolute left-0 z-40 w-full max-w-[15.5rem] overflow-hidden rounded-xl"
            {...menuMotion}
          >
